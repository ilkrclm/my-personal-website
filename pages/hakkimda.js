...
const AboutPage = () => {
  ...
  return (
    <MainLayout image={theme === 'dark' ? "/images/home-bg-dark.png" : "/images/home-bg.png"} path={activeLocale === 'en' ? '/en/hakkimda' : '/hakkimda'} baslik={t.about_title} description={t.about_description.substring(0, 150)}>
